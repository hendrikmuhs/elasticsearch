...
public class Pivot {
    ...
    public CompositeAggregationBuilder buildChangesAggregation(Map<String, Object> position, int pageSize) {

        CompositeAggregationBuilder c = createCompositeAggregationWithoutSubAggregations(config);
        c.aggregateAfter(position);
        c.size(pageSize);
    ...
    private static CompositeAggregationBuilder createCompositeAggregationWithoutSubAggregations(PivotConfig config) {
        CompositeAggregationBuilder compositeAggregation;
